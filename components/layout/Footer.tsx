        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-[#465650]">
            ...
            <div className="flex gap-3 mt-2">
              <Link href="/" className="text-[#465650] hover:text-[#101A17] transition-colors" aria-label="Twitter">
                🐦
              </Link>
              <Link href="/" className="text-[#465650] hover:text-[#101A17] transition-colors" aria-label="LinkedIn">
                💼
              </Link>
              <Link href="/" className="text-[#465650] hover:text-[#101A17] transition-colors" aria-label="Instagram">
                📸
              </Link>
            </div>
          </div>

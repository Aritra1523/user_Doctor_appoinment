            ...
            <div className="flex-1 p-6 md:p-7">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                ...
                >
                  ...
                  <p className="text-[10px] text-[#5B6864] mt-0.5">
                    {stats ? `${stats.reportsReady} ready` : "See results"}
                  </p>
                </Link>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-2">
                {nearby.data.slice(0, 3).map((centre) => (
                  <Link
                    key={centre.id}
                    href={`/diagnostics/${centre.id}`}
                    className="bg-white border border-[#DEE3E0] rounded-2xl p-3.5 flex items-center justify-between hover:shadow-sm transition-shadow"
                  >
                    <div>
